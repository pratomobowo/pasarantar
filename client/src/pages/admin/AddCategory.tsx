...
export default function AddCategory() {
  ...
  const {
    ...
    handleSubmit,
    setError,
  } = useAdminForm<CategoryFormData>(defaultData, {
    onSubmit: (data) => adminApi.createCategory(data),
    onSuccessMessage: 'Kategori berhasil ditambahkan',
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <h3 className="mt-4 text-lg font-medium text-gray-900">Menyimpan kategori...</h3>
          <p className="mt-2 text-sm text-gray-500">Kategori berhasil ditambahkan</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <FormHeader
        ...
        subtitle="Tambah kategori produk baru"
